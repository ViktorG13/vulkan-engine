...
namespace lve
{
  ...
  LvePipeline::LvePipeline(LveDevice &device, const std::string &vertexFilePath, const std::string &fragFilePath, const PipelineConfigInfo &configInfo) : lveDevice(device)
  {
